...
// PDF Export for Break Attendance
const generateBreakAttendancePDF = (data, options, res) => {
  const {
...
// Excel Export for Break Attendance
const generateBreakAttendanceExcel = async (data, options) => {
  const {
    title = 'Break Attendance Report',
    subtitle = '',
    dateRange = '',
...
module.exports = {
  generateBreakAttendancePDF,
  generateBreakAttendanceExcel
};